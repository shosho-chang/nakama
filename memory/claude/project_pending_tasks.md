...
- ⚠️ **VPS 部署待修修**：PR #136 + PR #137 都需要 `git pull && systemctl restart thousand-sunny` 才在 nakama.shosho.tw 生效；沒新 env key、不用 diff `.env`（per `feedback_vps_two_services.md`）
