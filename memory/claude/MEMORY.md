...
- [feedback_dispatch_everything_minimize_main_context.md](feedback_dispatch_everything_minimize_main_context.md) — **最高指導原則 2026-05-04**：所有可 dispatch 工作（review fix / conflict / refactor / partial agent recovery）一律 dispatch sub-agent 或 sandcastle；main context 只做決策 / prompt 寫作 / final approval。520k token breach 教訓
