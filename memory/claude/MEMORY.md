...
- [project_session_2026_05_04_evening_qa_sync_blocker.md](project_session_2026_05_04_evening_qa_sync_blocker.md) — **收工 2026-05-04 夜**：PRD #337 QA 跑 Phase 0-3 揭露 sync LLM systematic invalid JSON P0；9 條 bug log；卡點 #7 grill 凍 fix plan（Q1=A tool_use / Q2=三件並做 / Q3=B 已滿足 直接開 fix branch）；annotation_merger temperature fix 在 stash@{0} 等接
- Plan：[docs/plans/2026-05-04-sync-llm-json-contract-fix.md](../../docs/plans/2026-05-04-sync-llm-json-contract-fix.md) — sync hotfix 完整 plan（tool_use rewrite + error surface + idempotency short-circuit + 6 tests + acceptance）
