...
- [project_line1_multi_channel_cadence.md](project_line1_multi_channel_cadence.md) — **Line 1 multi-channel cadence 方向 2026-05-24**：長期 = Option Z (per-channel publish lifecycle)；暫收 Option X (blog-published terminal)；YouTube 線優先；未來 FB/IG adapter 上線或修修回報 chip 跳綠太早時重評
