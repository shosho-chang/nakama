...
| 層 | 名字 |
|---|---|
| Repo path | `extensions/news-coo/` (in Nakama monorepo since 2026-05-10) |
...
- 程式碼住在 nakama monorepo `extensions/news-coo/`（2026-05-10 從原獨立 `E:\news-coo` repo subtree-import 進來，歷史保留；原獨立 repo retire）
