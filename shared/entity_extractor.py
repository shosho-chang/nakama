...
:class:`shared.entity_promotion_engine.EntityPromotionEngine.propose`.
...
implementations live outside the ``shared.promotion_*`` boundary).
...
:class:`shared.dry_run_extractor.DryRunClaimExtractor`.
"""
