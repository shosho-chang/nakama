...
to ``shared.kb_concept_index_default``).

Production implementation of the ``KBEntityIndex`` Protocol declared in
:mod:`shared.entity_promotion_engine`. Scans both
...
Hard invariants (mirror :mod:`shared.kb_concept_index_default`):
...
_logger = get_logger("nakama.shared.kb_entity_index_default")
