...
Parallels :mod:`shared.concept_promotion_engine`. Diverges in two
intentional ways:
...
_logger = get_logger("nakama.shared.entity_promotion_engine")
...
class KBEntityIndex(Protocol):
    ...
    :class:`shared.concept_promotion_engine.KBConceptIndex` shape."""
