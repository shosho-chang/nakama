...
_ANNOTATIONS = json.dumps(
    [
        {
            "text": "作者說睡眠不足會累積成債，週末補眠只能還一部分",
            "note": "跟我自己輪班經驗吻合，值得寫進睡眠主題",
        },
        {
            "text": "每次切換任務都會留下注意力殘留，深度工作需要至少 90 分鐘不中斷",
            "note": "這解釋了為什麼我開會後寫不了稿",
        },
        {
            "text": "本書第三章講到芝加哥學派的價格理論",
            "note": "跟主題無關，純粹覺得有趣",
        },
        {
            "text": "習慣的複利：每天進步 1%，一年後是 37 倍",
            "note": "這個和投資複利是同一個數學",
        },
    ],
    ensure_ascii=False,
