"""Tests for agents.robin.promotion.video_speaker_entity_extractor (ADR-035 PR4)."""

from __future__ import annotations

from agents.robin.promotion.video_speaker_entity_extractor import VideoSpeakerEntityExtractor
...
def test_extractor_default_uses_module_singleton_store(monkeypatch):
    ...
    import agents.robin.promotion.video_speaker_entity_extractor as mod
