"""Tests for agents.robin.promotion.promotion_renderer — `render_review_item` ADR-034 v2 §D3.
...
from agents.robin.promotion.promotion_renderer import (
    render_concept_page,
    render_review_item,
    render_source_page,
)
...
def test_render_review_item_dispatches_entity_byte_identical() -> None:
    ...
    from agents.robin.promotion.promotion_renderer import render_entity_page
