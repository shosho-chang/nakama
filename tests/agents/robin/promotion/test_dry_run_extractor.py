"""Tests for ``agents.robin.promotion.dry_run_extractor.DryRunClaimExtractor`` (N518b).
...
def test_dry_run_extractor_module_does_not_import_anthropic():
    """Subprocess: import ``agents.robin.promotion.dry_run_extractor`` and assert
    ...
    code = (
        ...
        "importlib.import_module('agents.robin.promotion.dry_run_extractor');"
