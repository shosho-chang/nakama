...
chapter_index: 3
chapter_title: 3 Biochemical Concepts
figures:
- alt_text: A diagram depicts an atom as the basic unit of matter, and it consists
    of three main subatomic particles. The atom's nucleus contains six protons and
    six neutrons, and there are also six electrons in the orbit. The nucleus represents
    the central core of the atom, and contains protons and neutrons. The outer circle
    represents the second electron cell and the second inner cell represents the first
    electron cell.
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03f001.png
  vision_class: schematic
  vision_status: caption_only
- alt_text: 'A set of eight diagrams depicts a basic diagrammatic representation of
    the atomic structure of several stable atoms. These atoms consist of even smaller
    subatomic particles: protons, neutrons, and electrons. a. A first electron shell
    represents the innermost shell where electrons reside. b. A second electron shell
    represents the shell surrounding the first electron shell. c. It represents Nitrogen,
    Atomic number = 7, mass number = 14 or 15, atomic mass = 14.01. d. It represents
    oxygen, atomic number = 8, mass number = 16, 17, or 18, and atomic mass = 16.00.
    e. A third electron represents the shell surrounding the second electron shell.
    It represents sodium, atomic number = 11, mass number = 23, atomic mass = 22.99.
    f. It represents chlorine, atomic number = 17, mass number = 35 or 37, and atomic
    mass = 35.45. g. A fourth electron shell surrounds the third electron shell. Only
    Sodium and Chlorine have a fourth shell in the image. h. A fifth electron shell
    is the outermost shell for Potassium.'
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03f002.png
  vision_class: schematic
  vision_status: caption_only
- alt_text: A structure depicts the basic flow of matter. Atoms are the building blocks
    of elements. They consist of protons, neutrons, and electrons. Isotopes are variants
    of an element with the same number of protons but different numbers of neutrons.
    Arrows indicate that atoms can gain or lose neutrons and protons, however this
    typically creates a different element. The main elements in biomolecules are carbon,
    hydrogen, oxygen, and nitrogen. The biomolecules are categorized into carbohydrates,
    fats, and proteins.
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03f003.png
  vision_class: flow-diagram
  vision_status: caption_only
- alt_text: a. A diagram is a process of sodium chloride Na Cl formation through ionic
    bonding. It represents Sodium Na has one valence electron in its outermost shell.
    It displays a neutral sodium atom. b. A diagram depicts that Chlorine Cl has seven
    valence electrons. A sodium atom donates its valence electron to a chlorine atom.
    c. A diagram depicts an ionic bond in sodium chloride (NaCl). Na power + and Cl
    power - ions attract each other due to opposite charges. They arrange themselves
    in a crystal lattice structure. Each Na power + ion is surrounded by six Cl power
    - ions. d. A diagram depicts the packing of ions in a crystal of sodium chloride.
    The repeating pattern of Na power + and Cl power - ions in a 3D arrangement.
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03f004.png
  vision_class: schematic
  vision_status: caption_only
- alt_text: A diagram illustrates the process of covalent bond formation. It features
    an oxygen O atom and two hydrogen H atoms. Oxygen has six valence electrons, while
    hydrogen has only one. The oxygen atom shares two of its valence electrons with
    each hydrogen atom. The result is a water H subscript 2 O molecule.
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03f005.png
  vision_class: schematic
  vision_status: caption_only
- alt_text: normal upper C 6 normal upper H 12 normal upper O 6 equals left-parenthesis
    12 times 6 right-parenthesis plus left-parenthesis 1 times 12 right-parenthesis
    plus left-parenthesis 16 times 6 right-parenthesis equals 180
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0001.png
  vision_class: other
  vision_status: caption_only
- alt_text: a. A molecular structure of glucose molecule. b. A molecular structure
    of glucose. c. A molecular structure of glucose.
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03f006.png
  vision_class: schematic
  vision_status: caption_only
- alt_text: A diagram of a chemical bond between two chlorine atoms forming a chlorine
    molecule. It illustrates the chemical reaction where hydrogen gas H subscript
    2 reacts with oxygen gas O subscript 2 to form water H subscript 2 O. This process
    is an example of a chemical reaction involving energy transformation.
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03f007.png
  vision_class: schematic
  vision_status: caption_only
- alt_text: A flowchart illustrates the heart of this process lies food, which includes
    carbohydrates, fats, and proteins. ATP is used to power various cellular activities,
    such as muscle contraction, active transport, and synthesis of molecules.
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03f008.png
  vision_class: flow-diagram
  vision_status: caption_only
- alt_text: a. A chemical structure of Adenine, Ribose, and Phosphate groups. The
    three structures are commonly labeled as Adenosine triphosphate A T P.  b. An
    equation depicts ATP hydrolysis. c. An equation depicts the resynthesis of ATP.
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03f009.png
  vision_class: schematic
  vision_status: caption_only
- alt_text: normal upper A plus normal upper B right-arrow upper A upper B
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0002.png
  vision_class: other
  vision_status: caption_only
- alt_text: upper A upper B right-arrow normal upper A plus normal upper B
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0003.png
  vision_class: other
  vision_status: caption_only
- alt_text: upper A upper B left-right-arrow normal upper A plus normal upper B
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0004.png
  vision_class: other
  vision_status: caption_only
- alt_text: normal upper A plus normal upper P Subscript i Baseline right-arrow upper
    A upper P Subscript i
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0005.png
  vision_class: other
  vision_status: caption_only
- alt_text: upper A upper P Subscript i Baseline right-arrow normal upper A plus normal
    upper P Subscript i
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0006.png
  vision_class: other
  vision_status: caption_only
- alt_text: upper A upper B plus upper C upper D right-arrow upper A upper C plus
    upper B upper D
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0007.png
  vision_class: other
  vision_status: caption_only
- alt_text: normal upper A Superscript 3 plus Baseline plus normal upper B Superscript
    plus Baseline right-arrow normal upper A Superscript 2 plus Baseline plus normal
    upper B Superscript 2 plus
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0008.png
  vision_class: other
  vision_status: caption_only
- alt_text: Molecular formula of glucose equals normal upper C 6 normal upper H 12
    normal upper O 6
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0009.png
  vision_class: other
  vision_status: caption_only
- alt_text: Atomic mass of glucose equals left-parenthesis 12 times 6 right-parenthesis
    plus left-parenthesis 1 times 12 right-parenthesis plus left-parenthesis 16 times
    6 right-parenthesis equals 180
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0010.png
  vision_class: other
  vision_status: caption_only
- alt_text: 1 molar left-parenthesis upper M right-parenthesis glucose solution therefore
    equals 180 normal g slash normal upper L
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0011.png
  vision_class: other
  vision_status: caption_only
- alt_text: 1 normal upper M equals 180 normal g slash normal upper L
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0012.png
  vision_class: other
  vision_status: caption_only
- alt_text: 1 m upper M equals 180 m g slash normal upper L
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0013.png
  vision_class: other
  vision_status: caption_only
- alt_text: 5 m upper M equals 900 m g slash normal upper L italic or
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0014.png
  vision_class: other
  vision_status: caption_only
- alt_text: 900 m g in 1000 m upper L
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0015.png
  vision_class: other
  vision_status: caption_only
- alt_text: 5 m upper M in 1 normal upper L equals 900 m g in 1000 m upper L
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0016.png
  vision_class: other
  vision_status: caption_only
- alt_text: 5 m upper M in 10 m upper L equals left-parenthesis 900 slash 1000 right-parenthesis
    times 10 equals 9 m g
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0017.png
  vision_class: other
  vision_status: caption_only
- alt_text: upper H upper C l plus upper K upper O upper H right-arrow normal upper
    H Superscript plus Baseline plus upper C l Superscript minus Baseline plus normal
    upper K Superscript plus Baseline plus upper O upper H Superscript minus Baseline
    right-arrow upper K upper C l plus normal upper H 2 normal upper O
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0018.png
  vision_class: other
  vision_status: caption_only
- alt_text: A chemical structure of lactic acid, lactate.
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03g001.png
  vision_class: schematic
  vision_status: caption_only
- alt_text: p upper H equals log left-brace 1 slash left-bracket normal upper H Superscript
    plus Baseline right-bracket right-brace equals minus log left-bracket normal upper
    H Superscript plus Baseline right-bracket
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0019.png
  vision_class: other
  vision_status: caption_only
- alt_text: A drawing depicts the pH scale. The pH scale ranges from 0 to 14. A pH
    of 7.0 is considered neutral neither acidic nor alkaline. Acidic substances have
    a pH below 7.0. Alkaline or basic substances have a pH above 7.0. The scale is
...
- alt_text: normal upper H Superscript plus Baseline plus upper H upper C upper O
    ...
    normal upper H 2 normal upper O plus upper C upper O 2
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0020.png
  vision_class: other
  vision_status: caption_only
- alt_text: normal upper H 2 upper C upper O 3 right-arrow normal upper H Superscript
    plus Baseline plus upper H upper C upper O 3 Superscript minus
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03-math-0021.png
  vision_class: other
  vision_status: caption_only
- alt_text: A basic structure of body cells is labeled as flagellum, cilium, proteasome,
    chromatin, nuclear pore, glycogen granules, nucleolus, rough endoplasmic reticulum,
    ribosome, Golgi complex, and microfilament. The cytoskeleton consists of microtubules,
    microfilaments, Intermediate filaments, and microvilli. The centrosome consists
    of pericentriolar material, Centrioles, Secretory vesicles, lysosome, smooth endoplasmic
    reticulum, peroxisome, mitochondrion, and microtubule.
  vault_path: Attachments/Books/biochemistry-for-sport-and-exercise-maclaren/c03f011.png
  vision_class: schematic
  vision_status: caption_only
- alt_text: A basic structure of the plasma membrane diagram parts are labeled as
    integral (transmembrane) proteins, peripheral proteins, cholesterol, pore, channel
    protein, and peripheral protein, Phospholipids are polar heads, fatty acid tails,
    and polar heads.
