...
A foundational chapter introducing the chemistry underpinning sport and exercise biochemistry, covering atomic structure, bonding, chemical reactions, energy, water, acids/bases, and basic cell structure.
...
- Matter in the body exists as atoms, ions, molecules, and compounds, distinguished by charge state and the way atoms combine.
- Chemical bonds include ionic bonds (transfer of electrons producing charged ions) and covalent bonds (sharing of electrons).
- Chemical reactions transform reactants into products, and are classified energetically as endergonic (energy-absorbing) or exergonic (energy-releasing).
...
- Basic cell structure includes the plasma membrane, nucleus, cytoplasm, and mitochondria, each with distinct roles in cellular function.
...
- Provides the chemical foundation required to understand metabolic pathways, energy systems, and cellular function in sport and exercise contexts.
