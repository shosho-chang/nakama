...
The atomic mass (also called atomic weight) of an element is the average mass of all its naturally occurring isotopes. It is expressed in atomic mass units (amu), with the standard unit being the dalton (Da), defined as one-twelfth the mass of a carbon-12 (12C) atom, equivalent to approximately 1.66 × 10⁻²⁴ g.

## Core Principles

- Atomic mass reflects an isotope-weighted average rather than the mass of any single atom.
- The dalton (Da) is operationally defined relative to the carbon-12 atom: 1 Da = 1/12 the mass of a 12C atom ≈ 1.66 × 10⁻²⁴ g.
- Subatomic particle masses in Da:
	- Neutron ≈ 1.008 Da
	- Proton ≈ 1.007 Da
	- Electron ≈ 0.0005 Da (negligible relative to nucleons)
...
- Used to compute molar masses and stoichiometric relationships in biochemistry (e.g., calculating molecular weights of metabolites, enzymes, and substrates relevant to sport and exercise biochemistry).
- Underpins conversions between mass and mole quantities when preparing solutions or interpreting analytical data.
