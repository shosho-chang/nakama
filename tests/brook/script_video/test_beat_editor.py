"""Tests for ``agents.brook.script_video.beat_editor`` (ADR-038 §D3 + §D6).
...
from agents.brook.script_video.beat_aligner import AnchorNotFoundError
from agents.brook.script_video.beat_editor import (
    BeatEdit,
    DuplicateBrollFrom,
    MarkAroll,
    MergeBeats,
