...
class TestScheduleEntry:
    ...
    def test_conflict_writes_plan_no_link(self, vault, monkeypatch):
        ...
        # plan entry still written (vault-first)
        assert _entry(vault, "2026-06-03")["start"] == "2026-06-03T09:00:00+08:00"
        assert "calendar_event_id" not in _entry(vault, "2026-06-03")
