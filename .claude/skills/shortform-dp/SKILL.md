...
- brook-dp〈修修本人情境的固定 stand-in〉——同一位模特兒是跨集品牌一致性，與畫幅無關。
  修修 2026-09-14 擴大成「**每次搜尋都先看他的作品集**」，短片線同樣適用
- brook-dp〈選片鐵則〉3 的語意判準（畫面＝語意、情緒極性）與 5 的負面意象禁用清單

⚠️ **本地素材庫 `E:\data\stock footage\asian man` 對短片沒有用**：那十一支全是橫式
（4096×2160）。短片線要他的素材只能回 Envato 重搜，而且搜尋 URL 就要帶
`filter.orientation=Vertical`——直式是硬條件，裁不出來。
