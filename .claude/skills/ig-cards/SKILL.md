...
Before acting, read [`../../../skills/ig-cards/SKILL.md`](../../../skills/ig-cards/SKILL.md) in full and follow it as the canonical workflow. Resolve every relative path in that workflow from `skills/ig-cards/`.

Do not copy or extend the workflow here. Update the canonical skill and its direct references instead.
