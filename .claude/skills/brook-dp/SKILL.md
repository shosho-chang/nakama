...
## 修修本人情境的固定 stand-in（修修 2026-08-06 裁決，2026-09-14 擴大）

**凡 b-roll 要描述「修修本人在做某件事」**（第一人稱敘事的 stock 代打：用電腦、
上課課金、跌坑、學習、閱讀⋯⋯），**一律用同一位模特兒**——跨集視覺一致，
觀眾把他讀成「修修的化身」，不同男模特兒輪流充當是視覺 bug：

### 2026-09-14 擴大：他是**首要人選**，不是只有第一人稱時才用

> 「`YuriArcursPeopleimages` 這個帳號底下的留鬍子亞洲男性當作 stock footage 的
> 首要人選，**每次搜尋一定要看這個帳號底下有沒有適合的**。」

原本這一節只管「畫面要演修修本人」的場合。現在放寬：**任何一次 stock 搜尋，先看
他的作品集裡有沒有能用的**，再去看別人的。理由跟原本一樣、只是套用得更廣——
同一張臉反覆出現，觀眾讀得出這是同一個頻道，而不是一堆無關的 stock 拼起來。

**先查本地素材庫，再去 Envato**：`E:\data\stock footage\asian man`，
**索引在同資料夾的 `INDEX.md`**（情境關鍵詞 → 檔名 → 規格，逐支核過臉）。
已經下載過的直接用，不必重抓也不必再付一次授權流程。新抓的他的素材也一律放這裡，
並回頭補那張表。

⚠️ **核臉要防兩個方向，不是一個。** 原本這一節寫的「該帳號旗下有多位模特兒，每次
都要核對臉」防的是**誤收別人**。2026-09-14 我犯了反方向的錯：把庫裡那支健身房的
標成「另一位模特兒」（理由是捲髮、體格壯得多、膚色較深、鬍型較粗），修修當場更正
**那也是他**——高對比側光、充血的肌肉、汗濕往後撥的頭髮、用力的表情，四件事疊起來
就足以讓三張靜格得出錯誤結論。

所以：只有「**確定不是他**」才排除，不確定就**問修修**，不要自己判死；排除前至少
看一段動態而不是幾張靜格；比對拿鼻型、眉骨、下顎線與鬍子連鬢角的走向，
**不要拿體格、膚色、髮型比**——那三樣會隨情境、打光與拍攝期間改變。

⚠️ **庫裡十一支有十支是 4096×2160 DCI 4K**（1.896:1，不是 16:9），放進 16:9 時間軸
要靠 `centerCrop`。`scripts/build_resolve_project.py` 已經設好；走別條路上軌要自己處理。
