...
標記一個轉折；觀眾在那兩三秒裡只看得到這行字。

手冊寫的是「選轉折點、**貼原話**」——「貼原話」指的是**意義忠於原話**，不是把逐字稿
中間十個字原封不動剪下來。修修 2026-09-07 對標題講過同一件事：「不用一定要跟著逐字
稿，表達的意義相近就好。」Hero 同理。

- **主詞要在卡上。** 「花了快一百萬」——誰花的、為什麼花，一個都看不出來。
- **要是一句主張，不是一聲驚呼。** 「喔我爸就是這樣」是對話裡的反應詞，不是論點。
- **代名詞要有先行詞。** 「被接住了才有力量」——被誰接住？卡上沒有。
- **8–16 個中文字**；需要斷成兩行時用一個逗號，渲染器會照標點斷（定版
  `punch_card_wide` tier1 最多三行、每行 96px）。
- 全片上限 4 張，且不要跟同一節的轉場卡講同一件事。

實例（2026-09-01 蘇予昕〈拖延不是懶〉，四張全部不及格）：

| 交出來的 | 為什麼不及格 | 應該長這樣 |
|---|---|---|
| 喔我爸就是這樣 | 對話中的驚呼，不知道誰對誰做了什麼 | 原來源頭是我爸 |
| 花了快一百萬 | 只有一個數字，看不出在講什麼 | 為了準備，設備買到一百萬 |
| 一天六七千個念頭 | 有數字但沒有述語，念頭在幹嘛？ | 一天六七千個念頭都在罵自己 |
| 被接住了才有力量 | 「被接住」沒有先行詞 | 被允許不做，才有力氣做 |
