...
Pattern mirrors :mod:`agents.robin.promotion.video_source_map_builder` — bypass-engine
...
from agents.robin.promotion.video_source_map_builder import _parse_t_locator_pair
...
_logger = get_logger("nakama.agents.robin.promotion.video_speaker_entity_extractor")
...
def _format_locator(start: float) -> str:
    ...
    :func:`agents.robin.promotion.video_source_map_builder._format_locator`."""
    if start == int(start):
