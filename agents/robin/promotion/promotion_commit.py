...
markdown via ``agents.robin.promotion.promotion_renderer``, and writes through the
...
5. Render: ``agents.robin.promotion.promotion_renderer.render_*_page``.
...
from agents.robin.promotion.promotion_acceptance_gate import AcceptanceGate
from agents.robin.promotion.promotion_renderer import render_review_item
...
_logger = get_logger("nakama.agents.robin.promotion.promotion_commit")
