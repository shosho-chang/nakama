...
Protocol declared in ``agents.robin.promotion.entity_promotion_engine``. Used by the
...
:func:`agents.robin.promotion.entity_promotion_engine._apply_policy` row 7 →
