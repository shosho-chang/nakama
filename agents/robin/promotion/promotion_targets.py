...
- ``agents.robin.promotion.promotion_acceptance_gate.AcceptanceGate.validate`` — inline
  ``isinstance(item, SourcePageReviewItem)`` branches at lines 115-128
- ``agents.robin.promotion.promotion_commit._resolve_target_path`` — helper at lines 501-521
