...
# repo_root/agents/brook/script_video/render_workers/hyperframes_worker.py → repo_root
...
async def render(
    ...
    ``agents.brook.script_video.export_hash.compute_beat_hash``; passing ``None`` is a
