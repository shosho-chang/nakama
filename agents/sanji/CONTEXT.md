...
## 稱號階序（2026-08-25 修修裁決，體系未定稿）

已裁定的約束：**四皇 > 王下七武海**（照原作實力位階）；**單季挑戰冠軍的份量搆不到
四皇**——季冠軍另外命名（命名歸修修）。體系設計持續中，暫記候選：四皇＝年度制
（四個領域各一位或其他年度尺度）、七武海＝艦長任命七席（原作本來就是公權力任命，
對位成立）、超新星＝首季新人。憲法底線不變：任何稱號不得建立在生涯總分排名上。
